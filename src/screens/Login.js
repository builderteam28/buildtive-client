  ...
  return (
    <View style={{ marginHorizontal: 30, flex: 1 }}>
      <View style={{ flex: 1, justifyContent: 'center' }}>
        ...
        <TextInput style={styles.textInput} placeholder="username" onChangeText={(text) => handleChange('username', text)} />
        <TextInput style={styles.textInput} placeholder="password" onChangeText={(text) => handleChange('password', text)} />
      </View>
      <View style={{ flex: 1, justifyContent: 'center' }}>
        <Button title="log in" style={{ backgroundColor: '#FFC536', marginBottom: 10 }} onPress={handleSubmit} />
        <Button title="log in with google" onPress={() => console.log('google button')} />
